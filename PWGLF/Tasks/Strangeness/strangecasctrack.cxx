...
struct StrangeCascTrack {
  ...
  Configurable<bool> doRequireFT0{"doft0", false, "true for offline trigger for Run 3"};
  Configurable<bool> doApplyPID{"dopid", false, "true for offline trigger for Run 3"};
  Configurable<bool> doApplyCuts{"docuts", true, "true for offline trigger for Run 3"};
